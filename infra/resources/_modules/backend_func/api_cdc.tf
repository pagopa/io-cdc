...
resource "azurerm_api_management_api" "cdc_v1" {
  ...
  import {
    ...
    content_value  = "https://raw.githubusercontent.com/pagopa/io-cdc/98072da95e7e1993f6103d328dec88e43dc31198/apps/backend-func/api/internal.yaml"
  }
}
...
resource "azurerm_api_management_named_value" "cdc_backend_func_url" {
  ...
  value_from_key_vault {
    secret_id = var.cdc_backend_func_url
  }
}
